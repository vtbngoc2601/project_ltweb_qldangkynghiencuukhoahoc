					  ...
					  <div class="row">
					    <div class="col-md-6">
					      ...
					      <div class="form-group">
					        ...
					        <input type="text" class="form-control" id="ma-so">
					      </div>
					      <div class="form-group">
					      ...
					      <div class="form-group">
					        ...
					        <input type="date" class="form-control" id="ngay-sinh">
					      </div>
					      <div class="form-group">
					      ...
					      <div class="form-group">
					        ...
					        <input type="text" class="form-control" id="so-cccd">
					      </div>
					    </div>
					    ...
					    <div class="col-md-6">
					      ...
					      <div class="form-group">
					        ...
					        <input type="text" class="form-control" id="nganh">
					      </div>
					      <div class="form-group">
					      ...
					      <div class="form-group">
					        ...
					        <input type="tel" class="form-control" id="so-dien-thoai">
					      </div>
					    </div> 
					    </div>
