        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">THÔNG TIN GIẢNG VIÊN</h1>
                        ...
                        <div class="row">
                                    ...
                                    <table>
									  ...
									  <tbody>
									    ...
									    <tr>
									      ...
									      <td>
									        <c:forEach var="todo" items="${listTodo}">
									          <c:out value="${todo.targetDate}" /><br>
									        </c:forEach>
									      </td>
									    </tr>
									    <tr>
	                        ...
	                        <div class="mt-4">
							    <button type="button" class="btn btn-secondary" style="margin-left: 30px">Cập nhật thông tin</button>
							    <button type="button" class="btn btn-success" style="margin-left: 30px">Xóa</button>
							  </div>
	                    </div>
